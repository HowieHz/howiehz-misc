...
- [presentation/](../../../tools/graphwar-killer/presentation/) contains presentation-layer modules: page panels are grouped under `settings/`,
  ...
  `dom/` contains DOM event adapters, `stage/` contains the screenshot-stage SVG overlay and polyline points formatting, and `status/` contains status aggregation and duration formatting.
