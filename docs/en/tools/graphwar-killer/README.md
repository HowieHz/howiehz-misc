...
- [workers/](../../../tools/graphwar-killer/workers/) contains Web Worker entry files: `detection/` holds the screenshot-detection main worker and soldier-template subworker, while `pathfinding/` holds the pathfinding main worker and one-click-clear edge worker.
