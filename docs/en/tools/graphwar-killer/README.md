...
- [presentation/](../../../tools/graphwar-killer/presentation/) contains presentation-layer modules: page panels are grouped under `settings/`, `detection/`, `pathfinding/`, `action/`, `screenshot/`, and `result/`; `stage/` contains the screenshot-stage SVG overlay; `status/` contains status aggregation and duration formatting.
