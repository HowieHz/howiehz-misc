...
export const graphwarKillerLocale = {
  ...
  ui: {
    ...
    settings: {
      ...
      recognition: {
        candidateTopRatio: "Candidate trim",
        candidateTopRatioAriaLabel: "Soldier template candidate trim ratio",
        candidateTopRatioTitle: "Only checks top-ranked vote candidates; 0.1 means only the top 10%.",
        heading: "Recognition",
        maximumSoldierCount: "Soldier limit",
        maximumSoldierCountAriaLabel: "Detected soldier count limit",
        maximumSoldierCountTitle: "Overrides the final Graphwar soldier detection count limit; default 40.",
      },
      simulator: "Simulator",
