...
export const graphwarKillerLocale = {
  ...
  pathfindingModes: [
    ...
    { value: "smart", label: "智能寻路", title: "点选目标士兵后自动寻找绕开识别障碍的路径。" },
    { value: "auto-graph", label: "一键清图", title: "从当前己方士兵出发，自动计算可击中的 x+ 方向士兵路径。" },
  ],
  algorithmModes: [
  ...
  ui: {
    ...
    pathfinding: {
      ...
      fastModeTitle:
        "快速模式通常更快且内存使用更低，适合大量目标；但可能遗漏不同路径、同最大击杀数的候选路线。关闭后会保留这些并列最佳路线，结果更完整，但速度更慢、内存使用更高。",
      ...
      modeAriaLabel: "寻路模式",
      modeTitle: "选择是否自动计算避障路径，或直接尝试一键清图。",
      ...
      unit: "px",
      workerCount: "并行数",
      workerCountAriaLabel: "一键清图并行 Worker 数量",
      workerCountTitle: "一键清图同时运行的 Worker 数量，实际不会超过可尝试士兵数。",
    },
    point: {
    ...
    settings: {
      ...
      recognition: {
        candidateTopRatio: "候选裁剪",
        candidateTopRatioAriaLabel: "士兵模板候选裁剪比例",
        candidateTopRatioTitle: "只检查投票排名靠前的候选；0.1 表示只检查前 10%。",
        heading: "识别设定",
        maximumSoldierCount: "士兵数上限",
        maximumSoldierCountAriaLabel: "识别士兵数量上限",
        maximumSoldierCountTitle: "覆盖 Graphwar 士兵识别的最终数量上限；默认 40。",
      },
      simulator: "模拟器设定",
