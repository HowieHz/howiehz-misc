...
export const graphwarKillerLocale = {
  ...
  status: {
    ...
    detection: {
      ...
      needBounds: "需要先识别或框选 Graphwar 棋盘边界",
  ...
  smartPathfinding: {
    ...
    needBounds: "需要先在“识别”面板点击“识别边界”或手动画框，标记棋盘边界后才能使用智能寻路",
    needDetection: "需要先在“识别”面板点击“识别物体”，识别出士兵和障碍后才能使用智能寻路",
    inProgress: {
      optimize: "优化路径节点",
      search: "搜索绕障路线",
      stopSuffix: "，在截图中右键停止",
    ...
    oneClickClear: {
      ...
      needDetection: "需要先在“识别”面板点击“识别物体”，识别出士兵和障碍后才能使用一键清图",
  ...
  ui: {
    ...
    detection: {
      autoDetection: "自动识别",
      autoDetectionTitle: "开启后，加载截图时自动识别边界和物体；修改识别设置时在当前边界内重新识别物体。",
      ...
      detectBounds: "识别边界",
      detectBoundsTitle: "从当前截图自动识别并标记 Graphwar 棋盘边界。",
      detectObjects: "识别物体",
      detectObjectsNeedBoundsTitle: "需要先识别或框选 Graphwar 棋盘边界。",
    ...
    instructions: {
      items: [
        ...
        "填好坐标范围和游戏模式；也可以先点“识别边界”，再点“识别物体”标记士兵和障碍。",
