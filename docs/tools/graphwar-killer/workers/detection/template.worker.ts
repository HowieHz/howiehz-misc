...
import type { GraphwarSoldierTemplateWorkerResponse } from "../../detection/template/protocol";
import { isGraphwarSoldierTemplateWorkerRequest } from "../../detection/template/protocol";
...
workerScope.addEventListener("message", (event) => {
  if (!isGraphwarSoldierTemplateWorkerRequest(event.data)) {
    return;
  }
