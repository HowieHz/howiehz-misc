...
5. Complete the manual Geetest security check when it appears, then choose `Check now / check in` to check immediately. A notification identifies whether each Geetest popup is for login, normal check-in, or Rush Check-in.
